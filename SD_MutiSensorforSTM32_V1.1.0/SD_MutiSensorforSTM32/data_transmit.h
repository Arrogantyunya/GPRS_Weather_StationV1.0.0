...
#define AIR_V4                              0x09 //第二代多合一气象站（带TF卡）

//设备运行模式
enum RunMode{
    NWK = 0, NWK_TF, SMS, SMS_TF, TF
};

#define DEFAULT_RUNMODE     NWK_TF
...
struct System_Run_Parameter{
    ...
    char g_RunMode_Ascll[7];                         //运行模式字符串缓存
    char g_RunMode;                                  //运行模式
    char g_SMS_Phone[12];
...
extern bool LED_For_Network_Flag;
extern bool Pre_Network_LED_Status;
extern bool Is_Access_Server_Status;

extern bool Quick_Work_Flag;
